      ...
      <nav className="absolute top-6 left-6 right-6 z-50 flex justify-between items-start font-sans pointer-events-none">
        <div className="bg-white text-black h-[64px] w-[64px] md:w-auto px-0 md:px-8 flex items-center justify-center md:justify-start rounded-[4px] pointer-events-auto shadow-sm overflow-hidden">
          ...
          <div className="hidden md:flex items-center gap-10">
            <a href="#home" className="text-[15px] font-medium uppercase tracking-[0.15em] text-black hover:text-gray-500 transition-colors duration-300">
              Home
            </a>
            <a href="#about" className="group text-[15px] font-medium uppercase tracking-[0.15em] text-black hover:text-gray-500 flex items-center gap-1.5 transition-colors duration-300">
              About Us
            </a>
            <a href="#services" className="text-[15px] font-medium uppercase tracking-[0.15em] text-black hover:text-gray-500 transition-colors duration-300">
              Services
            </a>
            <a href="#contact" className="text-[15px] font-medium uppercase tracking-[0.15em] text-black hover:text-gray-500 transition-colors duration-300">
              Contact Us
            </a>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 pointer-events-auto">
          ...
          <a href="#contact" className="hidden md:flex h-[52px] px-8 bg-[#1E40AF] hover:bg-[#CE0001] hover:text-[#ffffff] text-[#f4f4f5] text-[15px] font-semibold tracking-wider rounded-full items-center transition-all duration-300">
            Contact Us
          </a>
