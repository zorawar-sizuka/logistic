...
const ContactForm = () => {
  ...
  const handleFormSubmit = (e) => {
    ...
    const targetWhatsAppNumber = "+9779861097427"; 
          ...
          <div className="bg-white border border-gray-200 rounded-[24px] p-6 lg:p-8 shadow-[0_12px_40px_rgba(0,0,0,0.06)] relative overflow-hidden h-full flex flex-col justify-center">
            ...
            <form onSubmit={handleFormSubmit} className="relative z-10 flex flex-col gap-5">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                   <input required value={formData.goodsType} onChange={(e) => handleInputChange(e, 'goodsType')} type="text" placeholder="Type of Goods" className="w-full h-[46px] px-4 rounded-[4px] bg-gray-50 border border-gray-200 text-[14px] text-black placeholder:text-gray-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#1E40AF] focus:border-transparent transition-all" />
                   <input required value={formData.weight} onChange={(e) => handleInputChange(e, 'weight')} type="text" placeholder="Weight / Volume" className="w-full h-[46px] px-4 rounded-[4px] bg-gray-50 border border-gray-200 text-[14px] text-black placeholder:text-gray-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#1E40AF] focus:border-transparent transition-all" />
                   <input required value={formData.pickup} onChange={(e) => handleInputChange(e, 'pickup')} type="text" placeholder="Pickup Location" className="w-full h-[46px] px-4 rounded-[4px] bg-gray-50 border border-gray-200 text-[14px] text-black placeholder:text-gray-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#1E40AF] focus:border-transparent transition-all" />
                   <input required value={formData.delivery} onChange={(e) => handleInputChange(e, 'delivery')} type="text" placeholder="Delivery Location" className="w-full h-[46px] px-4 rounded-[4px] bg-gray-50 border border-gray-200 text-[14px] text-black placeholder:text-gray-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#1E40AF] focus:border-transparent transition-all" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                   <input required value={formData.fullName} onChange={(e) => handleInputChange(e, 'fullName')} type="text" placeholder="Full Name" className="w-full h-[46px] px-4 rounded-[4px] bg-gray-50 border border-gray-200 text-[14px] text-black placeholder:text-gray-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#1E40AF] focus:border-transparent transition-all" />
                   <input required value={formData.phone} onChange={(e) => handleInputChange(e, 'phone')} type="tel" placeholder="Phone Number" className="w-full h-[46px] px-4 rounded-[4px] bg-gray-50 border border-gray-200 text-[14px] text-black placeholder:text-gray-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#1E40AF] focus:border-transparent transition-all" />
                </div>
              </div>
