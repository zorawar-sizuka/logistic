...
// // Map Data: Perfectly proportioned percentage positions matching standard global cartography
// const networkData = [
//   {
//     id: 'na',
...
// const Map = () => {
//   // Initialize default active node for mobile context
...
//       {/* Global CSS Injection Layer for Ripple Delays and Custom Scrollbars */}
//       <style>{`
...
//       {/* Main Container: Stacked row approach */}
...
//               <span className="text-[12px] font-bold text-black tracking-[0.15em] uppercase">
//                 Global Logistics Network
//               </span>
//             </div>

//             {/* FIXED HEADING: Increased line-height (leading) and optimized margins to prevent docks from touching */}
...
//             {/* Maintained increased paragraph gap */}
...
//           <button className="group hidden sm:flex shrink-0 items-center gap-4 bg-[#f7f8f9] border border-black/[0.05] hover:border-[#1E40AF] hover:bg-[#1E40AF] hover:text-white text-[#111] px-6 py-3 rounded-full text-[14px] font-medium transition-all duration-300">
...
//                 <div 
//                   className="relative flex items-center justify-center -translate-x-1/2 -translate-y-1/2 cursor-pointer w-10 h-10"
//                   onMouseEnter={() => setActiveNode(region.id)}
//                   onClick={() => setActiveNode(region.id)}
//                 >
//                   <div className={`absolute w-8 h-8 md:w-12 md:h-12 rounded-full animate-ping pointer-events-none ${
//                     activeNode === region.id ? 'bg-[#CE0001]/40' : 'bg-[#1E40AF]/25'
//                   }`} />
//                   <div className={`absolute w-8 h-8 md:w-12 md:h-12 rounded-full animate-ping animation-delay-2000 pointer-events-none ${
//                     activeNode === region.id ? 'bg-[#CE0001]/20' : 'bg-[#1E40AF]/15'
//                   }`} />
//                   <div className={`relative z-10 w-[12px] h-[12px] md:w-[16px] md:h-[16px] rounded-full border-[2.5px] border-white shadow-md transition-all duration-500 ease-out ${
//                     activeNode === region.id ? 'bg-[#CE0001] scale-125' : 'bg-[#1E40AF] hover:scale-110'
//                   }`} />
//                 </div>
...
//                     ========================================= */}
//                 <div 
//                   className={`hidden lg:block absolute top-1/2 w-[320px] bg-white/95 backdrop-blur-xl border border-black/5 p-6 rounded-[20px] shadow-[0_20px_50px_rgba(0,0,0,0.12)] transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)]
//                     ${region.align === 'right' ? 'left-6' : 'right-6'}
//                     ${activeNode === region.id ? 'opacity-100 translate-x-0 pointer-events-auto' : 'opacity-0 scale-95 translate-x-4 pointer-events-none'}`}
//                   style={{ 
//                     transform: `translate(${activeNode === region.id ? '0' : region.align === 'right' ? '-12px' : '12px'}, -50%)`,
//                   }}
//                 >
...
//                   {/* Clean layout: Clean raw rendering of the logo stamp */}
...
//               ========================================= */}
//           <div className="block lg:hidden w-full mt-4 md:mt-8">
